          ...
          children: [
            ...
            },
            {
              ...
              children: [
                ...
                { id: uid(), name: 'Syeda Wajeeda Tabassum', role: 'D', spouse: 'Syed Siddique Ahmed', spouseRole: 'H', children: [{ id: uid(), name: 'Syed Ahmed Shayaan', role: 'S' }, { id: uid(), name: 'Syed Dilawar Adnan', role: 'S' }, { id: uid(), name: 'Syeda Archer Rhushinaz', role: 'D' }] },
...
export const SHAJRA_DATA: ShajraItem[] = [
  {
    ...
    lines: [
      ...
      { arabic: "إِلٰهِي بِحُرْمَةِ حَضْرَت بَانْدگی مِيَاں sَيّد اَٹَان شَهِيد فِی سَبِيلِ الله رَحْمَةُ اللهِ عَلَيْه", roman: "Ilahi bihurmat Hazrat Bandagi Miyan Syed Atan Shaheed-fi-Sabilillah (R.H)", urdu: "الہی بحرمت حضرت بندگی میاں سید اٹاں شہید فی سبیل اللہ رحمتہ اللہ علیہ" },
